...
export const skillsData = [
    ...
    },
    {
        ...
        description:`Terapias biológicas innovadoras, como PRP (plasma rico en plaquetas) y Células Madre, que regeneran tejidos y alivian el dolor articular. <span class="text-purple">Ideales para tratar lesiones y ralentizar el deterioro articular, promoviendo una mejora natural en la movilidad y calidad de vida.</span>`
    },
    {
        id:4,
        title:'Medicina deportiva',
        description:`Abordaje especializado en lesiones deportivas con técnicas avanzadas de diagnóstico y tratamiento.<span class="text-purple">Ayuda a los pacientes a recuperar su rendimiento físico, previniendo recaídas y optimizando su retorno a la actividad.</span>`
    },
    {
        id:5,
        title:'Prevencion de infecciones',
        description:`Protocolo de última generación que minimiza el riesgo de infecciones durante y después de la cirugía, garantizando mayor seguridad y tranquilidad para los pacientes. <span class="text-purple">Este enfoque multidimensional abarca 10 estrategias clave, que van desde la preparación preoperatoria, cuidados intraoperatorios y seguimiento postoperatorio, asegurando un control integral y resultados óptimos en la prevención de infecciones.</span>`
    },
    {
        id:6,
