...
const Biography: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="w-full relative bg-backBlack px-6 py-36 text-grey">
        ...
        <div className="pb-32 xl:grid xl:grid-cols-2 relative">
         ...
         <div>
           ...
           <div className="grid grid-cols-5 mt-4 fade-element">
            <img src="/public/svg/acreditaciones-01.svg" className='h-28'  alt="" />
            <img src="/public/svg/acreditaciones-02.svg" className='h-28'  alt="" />
            <img src="/public/svg/acreditaciones-03.svg" className='h-28'  alt="" />
            <img src="/public/svg/acreditaciones-04.svg" className='h-28'  alt="" />
            <img src="/public/svg/acreditaciones-05.svg" className='h-28'  alt="" />
           </div>
         </div>
          <div className="line-fade absolute bottom-0 -left-6 myWidth h-[0.5px] bg-grey"></div>
        </div>
        <div className="pt-12 text-purple xl:grid xl:grid-cols-2">
          <div className="fade-element">
